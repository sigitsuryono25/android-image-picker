...
import com.surelabs.imagepicker.features.ImagePickerFragment
import com.surelabs.imagepicker.features.ImagePickerInteractionListener
import com.surelabs.imagepicker.features.cameraonly.CameraOnlyConfig
import com.surelabs.imagepicker.helper.ConfigUtils
import com.surelabs.imagepicker.helper.IpLogger
import com.surelabs.imagepicker.helper.LocaleManager
import com.surelabs.imagepicker.helper.ViewUtils
import com.surelabs.imagepicker.model.Image
import com.surelabs.sample.databinding.ActivityCustomUiBinding
...
class CustomUIActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(com.surelabs.imagepicker.R.menu.ef_image_picker_menu_main, menu)
        return true
    }

    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        val menuCamera = menu.findItem(com.surelabs.imagepicker.R.id.menu_camera)
        if (menuCamera != null) {
            if (config != null) {
                menuCamera.isVisible = config!!.isShowCamera
            }
        }
        val menuDone = menu.findItem(com.surelabs.imagepicker.R.id.menu_done)
        if (menuDone != null) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == com.surelabs.imagepicker.R.id.menu_done) {
            imagePickerFragment.onDone()
            return true
        }
        if (id == com.surelabs.imagepicker.R.id.menu_camera) {
